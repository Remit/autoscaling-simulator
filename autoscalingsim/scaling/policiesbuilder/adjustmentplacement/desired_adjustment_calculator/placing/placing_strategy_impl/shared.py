...
class SharedPlacingStrategy(PlacingStrategy):
    ...
    def place(self,
        ...
        for provider_name, provider_nodes in placer.node_for_scaled_services_types.items():
            for node_name, node_info in provider_nodes:
                ...
                considered = list()
                for service_name in node_resources_taken.keys():
                    ...
                    single_placement_option_instances, cumulative_system_resources = self._attempt_to_add_other_services_to_the_shared_node(node_info, further_node_system_resources_taken)
    ...
    def _attempt_to_add_other_services_to_the_shared_node(self, node_info, further_node_system_resources_taken):

        cumulative_system_resources = SystemResourceUsage(node_info, instance_count = 1)
