...
class DesiredAspectValueCalculator(ABC):
    ...
    def compute(self, cur_aspect_val, metric_vals, current_metric_val = None, current_performance_metric_val = None):

        return self.post_processing_adjuster.adjust(self._compute_internal(cur_aspect_val, metric_vals, current_metric_val, current_performance_metric_val))

    @abstractmethod
    def _compute_internal(self, cur_aspect_val, metric_vals, current_metric_val, current_performance_metric_val):
