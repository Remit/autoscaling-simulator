...
class ScalingMetric:
    ...
    def __init__(self, service_name : str, region_name : str, metric_source_name : str, metric_name : str, submetric_name : str,
                 state_reader : StateReader, accessor_to_related_service_class : type, metric_converter : MetricConverter, metric_unit_type : type,
                 values_filter_conf : dict, values_aggregator_conf : dict, forecaster_conf : dict, correlator_conf : dict):
    ...
    def compute_desired_state(self, cur_timestamp : pd.Timestamp):
        ...
        if metric_vals.shape[0] > 0:
            ...
            return (converted_metric_vals, metric_vals.value[-1])
