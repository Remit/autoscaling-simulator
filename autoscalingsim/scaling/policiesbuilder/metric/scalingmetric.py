...
class MetricDescription:
    ...
    def __init__(self, service_name : str, aspect_name : str, metric_description_conf : dict):
        ...
        self.initial_service_representation_in_metric = ErrorChecker.key_check_and_load('initial_service_representation_in_metric', metric_description_conf, service_key, service_name)
