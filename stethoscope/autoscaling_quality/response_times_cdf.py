...
class ResponseTimesCDF:
    ...
    def comparative_plot(cls: type, simulations_by_name : dict, simulation_step : pd.Timedelta, figures_dir : str = None, names_converter = None):
        ...
        for region_name in regions:
            ...
            for simulation_name, response_times_regionalized_per_sim in response_times_regionalized_aggregated.items():
                ...
                cls._internal_plot(ax, response_times_regionalized_per_sim[region_name], simulation_step, simulation_name_as_label)

            cls._internal_post_processing(ax, region_name, figures_dir, len(response_times_regionalized_aggregated))
    ...
    @classmethod
    def _internal_post_processing(cls : type, ax, region_name : str, figures_dir : str = None, ncol : int = 1):
