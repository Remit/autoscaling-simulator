...
class OscillatingLoadGenerator:
    ...
    def generate_pattern(cls, interval_percentage : float, step_percentage : float, config : dict):
        ...
        for i in range(math.ceil(1 / period_as_percentage_of_interval)):
            for level_value in level_vals:
                ...
                vals.extend(ConstantLoadGenerator.generate_pattern(percentage_of_period * period_as_percentage_of_interval * interval_percentage, step_percentage, {'rps': rps}))
